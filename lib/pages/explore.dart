        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Row(
                children: [
                  Image.asset('assets/images/explore.png', height: 170),
                  const Spacer(),
                  SizedBox(
                    height: 170,
                    width: 230,
                ...
                children: [
                  Text(
                    ...
                    style: Theme.of(context)
                        .textTheme
                        .bodySmall
                        ?.copyWith(fontSize: 17, color: Color(0xffe17f2f)),
                  )
                ],
              ),
              const SizedBox(
              ...
              ExploreItems(
                items: const {
                  ...
                  "spice": {
                    ...
                    "is it aromatic?": [ "black pepper", "cinnamon", "clove", "herbal tea", "licorice", "mint" ]
                  },
                  "wood": {
                    "is it oaky?": ["new oak", "toasted oak"],
                    "taste a little nutty?": [ "almond", "pecan", "walnut"],
                  ...
                  "fruit": {
                    ...
                    "berry": [ "blackberry", "blueberry", "cherry", "raspberry"],
                    "tropical": [ "coconut", "lemon", "orange"],
                  },
                  "floral": [ "potpourri", "rose" ],
                  "sweet": {
                    "a buttery flavor": ["caramel", "maple syrup", "vanila"],
